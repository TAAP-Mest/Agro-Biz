        ...
        <div className="row g-4">
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="rounded position-relative fruite-item">
              <div className="fruite-img">
                <img
                  src="https://www.agromonti.com/wp-content/uploads/2020/08/SEEDS-CAULIFLOWER-MAYA-F1..jpg"
          ...
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="rounded position-relative fruite-item">
              <div className="fruite-img">
                <img
                  src="https://www.agromonti.com/wp-content/uploads/2020/08/SEEDS-SWEET-PEPPER-NIKITA.jpg"
                  className="img-fluid w-100 rounded-top"
                  alt
                />
              </div>
          ...
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="rounded position-relative fruite-item">
              <div className="fruite-img">
                <img
                  src="https://www.agromonti.com/wp-content/uploads/2020/08/SEEDS-CARROT-NEW-KURODA.jpg"
                  className="img-fluid w-100 rounded-top"
                  alt
                />
              </div>
          ...
          <div className="col-md-6 col-lg-4 col-xl-3">
            <div className="rounded position-relative fruite-item">
              <div className="fruite-img">
                <img
                  src="https://www.agromonti.com/wp-content/uploads/2020/07/SEEDS-BEET-CRIMSON-GLOBE.jpg"
                  className="img-fluid w-100 rounded-top"
                  alt
                />
              </div>
