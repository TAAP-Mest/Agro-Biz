            ...
            <Carousel controls={false} >
                  {
                    testimonialsData.map(testimonials => {
                      return (
                        <Carousel.Item interval={500} key={testimonials.id} className={styles.imageBox}>
                         
                         <img className= {styles.testimonyImage} src={testimonials.src} alt="" /> 
              ...
              <Container fluid className={styles.testimonialBox}>
                <div className={styles.appTestimonial}>
                  <h2>User Testimonials</h2>
                  <span className={styles.subtitle}>What our users say about us</span>
                </div>
