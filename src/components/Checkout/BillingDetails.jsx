                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="py-5">Altifura 5G</td>
                        <td className="py-5">Ghs4.99</td>
                      ...
                      <tr>
                        ...
                        <td className="py-5">CARROT NEW KURODA</td>
                        <td className="py-5">Ghs40.99</td>
                        <td className="py-5">1</td>
                        <td className="py-5">Ghs40.99</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="py-5">
                          <div className="py-3 border-bottom border-top">
                            <p className="mb-0 text-dark">Ghs50.97</p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="py-5">
                          <div className="py-3 border-bottom border-top">
                            <p className="mb-0 text-dark">Ghs73.97</p>
                          </div>
                        </td>
                      </tr>
                    </tbody>
